...
const CategoryCard = (props: Props) => {
    return (
        <div className={`  rounded-lg relative p-1 bg-gradient-to-t from-neutral-900/90 via-neutral-900/60 overflow-hidden cursor-pointer hover:drop-shadow
    ...
    `}>
            <Image src={`${props.img_source}&w=320&q=50`}
                ...
                objectFit='cover' className='absolute inset-0 opacity-100 -z-10 select-none'
                loading='lazy'
                placeholder='blur'
